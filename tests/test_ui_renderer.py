...
class UiRendererTests(unittest.TestCase):
    def test_render_index_includes_devops_partial(self):
        ...
        self.assertIn('workspaceRunCanSteer()', body)
        self.assertIn('currentWorkspaceRunCommandPreview()', body)
        self.assertIn('primeSteerComposer()', body)
